 ...
 * @package  RadeViewHtml
 * @version 1.9.1 2018-06-11 (1)
 * @link https://github.com/biustudios/radeview
 * @author   BiuStudio Ghana
 */
trait RadeViewManagerHtml
{
    ...
    protected function compileSection($expression) {
        return $this->phpTag."echo \$this->section{$expression}; ?>";
    }
    public function section($id,$class,$extra='')
    {
        if ($id !=null && $class !=null) {
    ...
    protected function compileHead($expression) {
        return $this->phpTag."echo \$this->head{$expression}; ?>";
    }
    public function head($id,$class,$extra='')
    {
        if ($id !=null && $class !=null) {
            return "<head id='".static::e($id)."' class='".static::e($class)."' $extra>";
        } else {
            return null;
        }
    }
