...
/**
 * trait RadeViewHtmlBootstrap
 * Copyright (c)  2016 BiuStudio Ghana MIT License. Don't delete this comment, its part of the license.
 * Extends the tags of the class RadeView.  Its optional
 ...
 *
 * @link https://github.com/biustudios/Radeview
 *
 * @author   Jorge Patricio Castro Castillo <jcastro arroba eftec dot cl>
 */
trait RadeViewHtmlBootstrap
{
    use RadeViewManagerHtml {
        RadeViewManagerHtml::select as selectParent;
        RadeViewManagerHtml::input as inputParent;
        RadeViewManagerHtml::commandButton as commandButtonParent;
        RadeViewManagerHtml::textArea as textAreaParent;
        RadeViewManagerHtml::item as itemParent;
        RadeViewManagerHtml::checkbox as checkboxParent;
        RadeViewManagerHtml::compileEndCheckbox as compileEndCheckboxParent;
        RadeViewManagerHtml::radio as radioParent;
        RadeViewManagerHtml::compileEndRadio as compileEndRadioParent;
    ...
    public function input($id = '$id', $value = '', $type = 'text', $extra = '')
    {
        $extra = $this->addClass($extra, 'form-control');
     ...
     * @return string
     */
    public function addClass($txt, $newclass)
    {
        if (is_array($txt)) {
    ...
    public function separatesParam($txt)
    {
        $result = [];
