 ...
 * </code>
 *
 * @version 0.19 2017-12-15 NOT YET IMPLEMENTED, ITS A WIP!!!!!!!!
 *
...
trait RadeCacheRedis
{
    public $curCacheId = 0;
    public $curCacheDuration = '';
    public $curCachePosition = 0;
    public $cacheRunning = false;
    ...
    public $redisConnected = false;
    public $redisNamespace = 'RadeViewCache:';
    public $redisBase = 0;
