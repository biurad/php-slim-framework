...
class RadeMinify
{
    ...
    public static function Html($buffer = '')
    {
        ...
        $optionalEndingTags = ['</option>', '</li>', '</dt>', '</dd>', '</tr>', '</th>', '</td>'];
    ...
    /**
     * Usually when you're using different CSS files on your site,
     * they might take a quite long to be loaded. Using this PHP code,
     * you can compress them into a single file with no unnecessary white spaces or comments.
     * Why we need to compress multiple CSS files? The answer is:
     * the compressing procedure may take a less time than a total time of loading each file separately.
     */
