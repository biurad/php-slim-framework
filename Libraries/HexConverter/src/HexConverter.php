...
class HexConverter
{
    ...
    public function hsl()
    {
        $color = [$this->hex[0].$this->hex[1], $this->hex[2].$this->hex[3], $this->hex[4].$this->hex[5]];
    ...
    public function cmyk()
    {
        ...
        return [round($cyan), round($magenta), round($yellow), round($black)];
    }
}
